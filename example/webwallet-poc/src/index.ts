...
import { hexStringToBuffer, uintArrayToHex } from "@vocdoni/common"
...
function randomInteger() {
    ...
    return getRndInteger(0, Number.MAX_SAFE_INTEGER) // golang will accept uint64 though.
}

export async function retryUntilSuccess(callback: Function, retries: number, interval: number) {
